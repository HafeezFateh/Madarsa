...
function Home(){
    return(
        <>
            ...
            <h1 className="mx-5 mt-10 text-2xl font-semibold text-stone-400">Courses</h1>
            <div className="h-[50px] bg-gradient-to-b from-transparent to-stone-950/60"></div>
            <div id="courses" className="bg-stone-950/60 p-2 flex flex-col items-center gap-4 ">
                <div className="p-5 w-[350px] h-[150px] bg-stone-50/10 rounded-xl flex flex-col items-center gap-3 justify-center">
